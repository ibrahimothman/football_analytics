...
![Match Summary](reports/match_id=YOUR_MATCH_ID/summary.png)

A high-level summary of the match, bringing together the key team-level performance metrics generated by the analytical pipeline.

---

### Shot Map

![Shot Map](reports/match_id=YOUR_MATCH_ID/shots.png)

Shows the location and outcome of shots taken by both teams, providing a spatial view of shooting patterns, chance locations, and attacking effectiveness.

---

### Expected Goals Timeline

![Expected Goals Timeline](reports/match_id=YOUR_MATCH_ID/xg_timeline.png)
...
![Progressive Pass Map](reports/match_id=YOUR_MATCH_ID/progressive_passes.png)

Visualizes passes that significantly progress the ball toward the opposition goal, highlighting how each team advanced possession and moved through the pitch.

---

### Expected Threat Momentum

![Expected Threat Momentum](reports/match_id=YOUR_MATCH_ID/xt_momentum.png)
