"""Silver event transforms from Bronze."""
...
def bronze_to_silver(
    ...
    validate_silver_type(df)
    reconcile_bronze_to_silver(bronze_df, df)
    run_silver_dq_checks(df)
    check_attacking_direction_using_shots(df)
